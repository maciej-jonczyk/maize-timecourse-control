---
title: "Control codition. Comparison of subsequent time-points to time zero in leaf"
format: html
date: "2026-02-05"
...
invisible(
  lapply(original_names, function(name) {
    ...
    pl_res_name <- paste0(name, "_leaf_pl")
    min_res_name <- paste0(name, "_leaf_min")
...
```{r save results}
# # select pattern
# to_save <- ls(pattern = "leaf_(pl|min)$")
# # check
# to_save
# 
# # saving
# save(list = to_save, file="../rdata-saved/sigs_leaf1.RDa")
...
# saving
save(list = to_save, file="../rdata-saved/sigs_all_leaf.RDa")
```
...
<!-- load("../rdata-saved/sigs_all_leaf1.RDa") -->
...
<!-- # select pattern -->
<!-- to_save <- ls(pattern = "_leaf_sig_fc05$") -->
<!-- # check -->
<!-- to_save -->
