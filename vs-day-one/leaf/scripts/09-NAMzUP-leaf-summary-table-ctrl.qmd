...
write.table(c15_m1.15_desc, file="../results/go/leaf-cluster-membership.txt", sep="\t", quote=FALSE, row.names=FALSE)
...
library(dplyr)
# Join everything
# Join cluster summary (c15_m1.15_desc) with GO description and gene description
