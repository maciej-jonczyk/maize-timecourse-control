---
title: "GO analysis for expression changes in SAM in control - ALL significant genes"
format: html
date: "2026-02-05"
...
write.table(expressed.genes, file="../results/go/expressed_genes_samALLsig-ctrl.txt", col.names=FALSE, row.names=FALSE, quote=FALSE)
...
```{bash make pop}
grep -Fwf ../results/go/expressed_genes_samALLsig-ctrl.txt ../../../../project1-stat/input-data/go-uniprot/NAM2GO_all_4making_pop > ../../../input-data/go-uniprot/SAM-ctrl.pop
```
...
Load the data from the mfuzz analysis for given number of clusters and fuzziness (computed in `07-SAM-only-mfuzzALLsig.qmd`, chunks `r check real` and `r selected`)

```{r load data}
#| message: false

# -------------- CHANGE FILE APPROPRIATELY ------------------ #
#load("../rdata-saved/mfuzz_c8_m1.2_samALLsig.RDa")
#load("../rdata-saved/mfuzz_c8_m1.25_samALLsig.RDa")
