...
write.table(cl14_m1.25_desc, file="../results/go/leaf-cluster-membership.txt", sep="\t", quote=FALSE, row.names=FALSE)
...
```{r go-summary}
# Join everything
# Join cluster summary (cl14_m1.25_desc) with GO description and gene description
