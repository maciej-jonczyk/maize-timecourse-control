---
title: "Prepare network files for analysis in Cytoscape - SAM, control"
format: html
date: "2026-05-12"
...
:::{.callout-note}
This script is a greatly improved version of sum of the [10-NAMzUP-SAM-networks-cytoscape-loop-ctrl.qmd](../../../vs-day-one/sam/scripts/10-NAMzUP-SAM-networks-cytoscape-loop-ctrl.qmd) and [10-NAMzUP-SAM-rel3-networks-cytoscape-ctrl.qmd](../../../vs-day-one/sam/scripts/10-NAMzUP-SAM-rel3-networks-cytoscape-ctrl.qmd). Joining part was changed from `bash` to `R`.
:::
...
# join and sort by UP
join -1 2 -2 1 -t $'\t' ../../../../../project1-stat/input-data/networks-up/best-nam-string-ids cl13_m1.25_sort | sort -k2,2 -t $'\t'> c13_UP_srt
...
zgrep -Fwf c13_ids_up ../../../../../project1-stat/input-data/networks-up/full-network.gz > c13_UP_net_selected
```
...
# NAM - UP assignment
grep Zm00001eb313790 ../../../../../project1-stat/input-data/go-uniprot/BEST_UPs
