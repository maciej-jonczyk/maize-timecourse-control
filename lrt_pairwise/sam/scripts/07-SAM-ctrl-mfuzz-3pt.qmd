---
title: "Mfuzz clustering of SAM data, minimum 3 significant genes from point by point comparisons, control."
format: html
date: "2026-05-11"
...
original_names = ls(pattern = "sam_ctrl_sig$")
...
vsd = varianceStabilizingTransformation(dds.f, blind=TRUE, fitType='local')
# changed fitType to avoid bad-fit warning
```
...
save(vsd.eset.ave.std, file="../rdata-saved/vsd.eset.ave.std.sam_ctrl_pair_min3pt.RDa")
```
...
# load("../rdata-saved/vsd.eset.ave.std.sam_ctrl_pair_min3pt.RDa")
